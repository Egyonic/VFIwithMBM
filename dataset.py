...
class VimeoDataset(Dataset):
    def __init__(self, dataset_name, batch_size=32, small_dataset=False):
        self.batch_size = batch_size
        self.dataset_name = dataset_name        
        self.h = 256
        self.w = 448
        self.data_root = '/home/usst/egyonic/data/vimeo_triplet'
        self.image_root = os.path.join(self.data_root, 'sequences')
        train_fn = os.path.join(self.data_root, 'tri_trainlist.txt')
        test_fn = os.path.join(self.data_root, 'tri_testlist.txt')
        #small dataset for quick test
        if small_dataset:
            train_fn = os.path.join(self.data_root, 'tri_small_trainlist.txt')
            test_fn = os.path.join(self.data_root, 'tri_small_testlist.txt')
...
class AniTriplet(Dataset):
    def __init__(self, dataset_name, batch_size=16, small_dataset=False):
        self.batch_size = batch_size
        self.dataset_name = dataset_name
        self.h = 256
        self.w = 448
        self.data_root = '/home/usst/egy/data/vimeo90k/vimeo_triplet'
        self.image_root = os.path.join(self.data_root, 'sequences')
        train_fn = os.path.join(self.data_root, 'tri_trainlist.txt')
        test_fn = os.path.join(self.data_root, 'tri_testlist.txt')
        # small dataset for quick test
