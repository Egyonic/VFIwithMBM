...
for i in f:
    ...
    I0, I1, I2 = crop(I0, I1, I2, 224, 224)
    if count % 1000 == 0 and save_result:
        cv2.imwrite(os.path.join(result_dir, f'im_{count}_I0.png'), I0)
        cv2.imwrite(os.path.join(result_dir, f'im_{count}_I1.png'), I0)
