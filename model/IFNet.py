...
class IFNet_bf_light_resnet_cbam_M(nn.Module):
    def __init__(self):
        ...
        self.block0 = IFBlock_bf_L_Light(6, c=360, tf_dim=64)
        self.block1 = IFBlock_bf_L_Light(13 + 4, c=220, tf_dim=64)
        self.block2 = IFBlock_bf_L_Light(13 + 4, c=120, tf_dim=128)
        self.block_tea = IFBlock_bf_L_Light(16 + 4, c=120, tf_dim=128)
        self.contextnet = resnet50_feature_L()
...
if __name__ == "__main__":
    ...
    flownet = IFNet_bf_light_resnet_cbam_M()
