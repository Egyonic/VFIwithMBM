...
from model.efficientvit.apps.data_provider.random_resolution import RRSController
from model.efficientvit.models.utils import val2tuple
...
class DataProvider:
    ...
    def build_dataloader(self, dataset: any or None, batch_size: int, n_worker: int, drop_last: bool, train: bool):
        ...
        if isinstance(self.image_size, list) and train:
            from model.efficientvit.apps.data_provider.random_resolution._data_loader import RRSDataLoader
